...
const App: React.FC = () => {
  ...
  return (
    <div className="text-gray-700 font-sans">
      ...
      <section id="ubicacion" className="py-8 sm:py-10">
        <div className="container mx-auto px-4 sm:px-6">
            <h2 className="text-xl sm:text-3xl font-bold text-center text-gray-800 mb-8">Visítanos y Contáctanos</h2>
            <div className="neumorphic-card overflow-hidden p-2 sm:p-4">
                ...
                <div className="text-center pt-6 pb-2 text-gray-800">
